...
class DataProcessor:
    def __init__(self, signals_filename, random_hands_filename):
        self.signals_csv_path = os.path.join('E:\\Projects\\libria\\data', signals_filename)
        self.random_hands_csv_path = os.path.join('E:\\Projects\\libria\\data', random_hands_filename)
    ...
    def process_images(self, signals):
        ...
        pixels_reshaped = signals.reshape(-1, 32, 32)
    ...
    def save_landmarks(self, labels, landmark_features):
        ...
        output_path = os.path.join('E:\\Projects\\libria\\data', 'processed_hands_in_landmarks.csv')
