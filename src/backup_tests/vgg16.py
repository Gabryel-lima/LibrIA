...
from conf import CFG_VGG16
#from plot import imshow, _plot_predictions, _plot_metrics, _plot_confusion_matrix Só funciona no torch e estou com preguiça de fazer a adaptação
...
if __name__ == "__main__":
    # Labels
    labels = CFG_VGG16.LABELS

    # Create Metadata
    list_path = []
    list_labels = []
    for label in labels:
        label_path = os.path.join(CFG_VGG16.DATA_DIR, label, "*")
    ...
    def data_augmentation():
        ...
        train_generator = datagen.flow_from_dataframe(
            ...
            batch_size=CFG_VGG16.BATCH_SIZE,
            target_size=(CFG_VGG16.IMG_SIZE, CFG_VGG16.IMG_SIZE),
        )
    ...
    CFG_VGG16.seed_everything()
    train_generator, validation_generator, test_generator = data_augmentation()

    # Load VGG16 model and modify for ASL recognition
    base_model = VGG16(weights='imagenet', include_top=False, input_shape=(CFG_VGG16.IMG_SIZE, CFG_VGG16.IMG_SIZE, CFG_VGG16.IMG_CHANNELS))
    ...
    history = model.fit(
        train_generator,
        steps_per_epoch=train_generator.samples // CFG_VGG16.BATCH_SIZE,
        epochs=CFG_VGG16.EPOCHS,
        validation_data=validation_generator,
        validation_steps=validation_generator.samples // CFG_VGG16.BATCH_SIZE,
